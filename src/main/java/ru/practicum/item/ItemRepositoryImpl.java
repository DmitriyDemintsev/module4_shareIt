...
//        userItems.compute(item.getOwner().getId(), (userId, itemList) -> {
//            if (itemList == null) {
...
//        for (Item itemCheck : findItemsByUserId(item.getOwner().getId())) {
//            if (!item.getId().equals(itemCheck.getId())) {
//                continue;
//            }
//            if (!item.getOwner().equals(itemCheck.getOwner())) {
